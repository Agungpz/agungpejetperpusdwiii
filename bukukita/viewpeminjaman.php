...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto py-8">
        ...
        <div class="flex justify-center mb-4">
            <a href="viewpeminjaman.php?filter=today" class="px-4 py-2 <?= $today ? 'bg-blue-500 text-white' : 'bg-gray-300 text-gray-700'; ?> rounded-lg">Hari Ini</a>
            <a href="viewpeminjaman.php" class="px-4 py-2 <?= !$today ? 'bg-blue-500 text-white' : 'bg-gray-300 text-gray-700'; ?> rounded-lg ml-4">Semua Hari</a>
        </div>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($peminjamans as $peminjaman) : ?>
                                <tr class="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td class="py-2 px-4 text-left"><?= isset($peminjaman['tanggal_peminjaman']) ? date('H:i:s', strtotime($peminjaman['tanggal_peminjaman'])) : '-'; ?></td>
                                    <td class="py-2 px-4 text-left"><?= isset($peminjaman['tanggal_kembalian']) ? date('Y-m-d', strtotime($peminjaman['tanggal_kembalian'])) : '-'; ?></td>
                                    <td class="py-2 px-4 text-left"><?= isset($peminjaman['tanggal_kembalian']) ? date('H:i:s', strtotime($peminjaman['tanggal_kembalian'])) : '-'; ?></td>
